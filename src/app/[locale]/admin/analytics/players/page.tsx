...
import {
  Search, Users, Link2, Link2Off, Gamepad2, ShieldCheck, ChevronLeft, ChevronRight,
} from "lucide-react";
                  ...
                  <div className="hidden md:flex items-center gap-2 shrink-0">
                    {p.account ? (
                      <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-green-700 bg-green-50 border border-green-200 px-2 py-1 rounded">
                        <Gamepad2 size={11} className="text-[#00A4EF]" />
                        {locale === "fr" ? "Microsoft" : "Microsoft"}
                      </span>
                    ) : (
                    ...
                    {p.staff && (
                      <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-indigo-700 bg-indigo-50 border border-indigo-200 px-2 py-1 rounded">
                        <Link2 size={11} />Discord
                      </span>
                    )}
                  </div>
