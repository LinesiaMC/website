  ...
  return (
    <footer className="bg-white">
      <div className="max-w-[1033px] mx-auto px-4">
        <div className="border border-border rounded-t-[20px] shadow-[0_0_20px_1px_rgba(0,0,0,0.02)] px-8 py-10">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            {/* Nav columns */}
            <div>
              <h4 className="text-[13px] font-semibold text-[#303030] mb-3">{t("navigation")}</h4>
            ...
            <div>
              <h4 className="text-[13px] font-semibold text-[#303030] mb-3">{t("resources")}</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="text-[13px] font-semibold text-[#303030] mb-3">{t("legal")}</h4>
              <ul className="space-y-2">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer"
                  className="text-[#343330] hover:text-black transition-colors" aria-label={social.label}>
